...
clear
bitcoind -daemon -fallbackfee=0.0001 -regtest
sleep 5
...
bitcoin-cli -regtest generatetoaddress 103 $mineraddr > /dev/null
input_0=$(bitcoin-cli -regtest -rpcwallet=Miner sendtoaddress $aliceaddr 20) 
input_1=$(bitcoin-cli -regtest -rpcwallet=Miner sendtoaddress $bobaddr 20) 
...
multijson=$(bitcoin-cli -rpcwallet=Alice -regtest addmultisigaddress 2 "[$alicehex,$bobhex]")
bitcoin-cli -rpcwallet=Bob -regtest addmultisigaddress 2 "[$alicehex,$bobhex]"
...
fund_multi_txid=$(bitcoin-cli -regtest sendrawtransaction $final_fund_multi_hex)
